...
O MdLinks é o 4° projeto da turma SAP009 da Laboratória.
MdLinks (linguagem de marcação) é uma ferramenta de linha de comando (CLI)
com a sua própria biblioteca (library) em JavaScript, desenvolvida a 
partir do Node.js, que analisa links em arquivos markdowne devolve
ao usuários suas características.

É usada em muitas plataformas que manipulam texto (GitHub, fórum, 
blogs e etc) e é muito comum encontrar arquivos com este formato em qualquer 
repositório (começando pelo tradicional `README.md`).

Os arquivos `Markdown` normalmente contém _links_ que podem estar
quebrados, ou que já não são válidos, prejudicando muito o valor da
informação que está ali, com o MdLinks é possível automatizar o 
proccesso de verificação desses _links_.

## 2. Backlog

Inicialmente para desenvolver o projeto foi criado um fluxograma, para
planejar e compreender todas as implementações do projeto.

FOTO

## 4. Utilização

Comando: 	md-links ./"rota-do-arquivo"/"arquivo.md"
FOTO

Comando: 	md-links ./"rota-do-arquivo"/"arquivo.md" --validate
FOTO

Comando: 	md-links ./"rota-do-arquivo"/"arquivo.md" --stats
FOTO

Comando: 	md-links ./"rota-do-arquivo"/"arquivo.md" --stats --validate
FOTO
